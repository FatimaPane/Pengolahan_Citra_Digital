...
def praktikum_6_1():
    ...
    degradations = {
        ...
        'Gaussian Noise (sigma=25)': (add_gaussian_noise(clean_img, 0, 25), None),
        'Salt & Pepper (p=0.05)': (add_salt_pepper_noise(clean_img, 0.05), None),
        'Speckle Noise (sigma=0.1)': (add_speckle_noise(clean_img, 0.1), None),
        'Motion Blur (L=15, theta=30 deg)': add_motion_blur(clean_img, 15, 30),
